...
def can_be_created_in_a_block(args = {title: 'Home Alone', release_date: 1990} )#title: 'Home Alone', release_date: 1990)
...
def can_find_using_where_clause_and_be_sorted
  ...
  # newer_movies = 
  # order(:release_date)
  Movie.reorder(:release_date).reverse_order.where('release_date > 2002')
